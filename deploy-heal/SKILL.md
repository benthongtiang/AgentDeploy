...
Error Logs/Failure Reason: $ARGUMENTS (The raw error logs, failure output, or error summary passed from the deployment stage).

## Instructions

### Step 1: Parse logs & Diagnose
1. Inspect the provided error logs or summary passed via $ARGUMENTS.
